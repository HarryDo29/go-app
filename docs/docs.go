    ...
    "paths": {
        ...
        "/auth/forget": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Forget Password Info",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/channel/{channel-id}/members/count": {
            "get": {
        ...
        "/connection/{connection-id}/respond": {
            "put": {
        ...
        "/message/{message-id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update Message Info",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "go-app_internal_dto.CreateGroupDto": {
            ...
            "properties": {
                ...
                "member_count": {
                    "description": "MemberIds   []string ` + "`" + `json:\"member_ids\" binding:\"required\"` + "`" + `",
                    "type": "integer"
                },
                "owner_id": {
                    "type": "string"
